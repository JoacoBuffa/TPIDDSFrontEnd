...
function Inicio() {
  return (
    <div className="text-center mt-4 shadow-lg mb-3 bg-dark text-white p-3 rounded" style={{ backgroundColor: "lightgray" }}>
      <h1 className="display-6 fw-bold text-center mt-4 shadow-lg mb-3 bg-dark text-white p-3 rounded">FULBO 2024</h1>
